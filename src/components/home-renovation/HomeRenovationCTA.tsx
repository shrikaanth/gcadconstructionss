          ...
          <div className="relative z-10">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                Ready to Transform
                <br />
                <span className="text-[#00aeef]">Your Home?</span>
              </h2>
              <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-4">
                Start your home upgrade with a free consultation
              </p>
              <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-12">
                We'll visit your home, discuss your vision, and provide a clear, honest quote with no obligations.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              {[
                { icon: Phone, title: 'Call Us', value: '+1 (437) 269-8805', subtitle: 'Mon-Fri: 8AM - 6PM' },
                { icon: Mail, title: 'Email Us', value: 'gcadconstruction1@gmail.com', subtitle: '24hr response time' },
                ...
                return (
                  <div
                    key={idx}
                    className="group p-8 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:bg-white/10 hover:border-[#00aeef]/50 transition-all duration-300 text-center"
                  >
