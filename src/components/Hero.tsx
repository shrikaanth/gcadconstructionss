      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#00aeef]/10 border border-[#00aeef]/30 rounded-full mb-8 backdrop-blur-sm">
            ...
            <span className="text-sm text-gray-300">Licensed • Ontario-Approved • 100+ Projects Completed</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
            Basements That <span className="text-[#00aeef] inline-block hover:scale-105 transition-transform duration-300">Add Value</span>.
            <br />
            Homes That Feel <span className="text-[#00aeef] inline-block hover:scale-105 transition-transform duration-300">New Again</span>.
          </h1>
          ...
          <p className="text-md text-gray-500 mb-12 italic">
            Built with precision. Delivered on time. Made for real Canadian living.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="group relative px-8 py-4 bg-[#00aeef] text-white font-semibold rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-[#00aeef]/50 hover:scale-105">
            ...
            <button className="px-8 py-4 bg-white/10 text-white font-semibold rounded-lg backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
              See Our Work
            </button>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { number: '100+', label: 'Renovations Completed' },
              { number: '$47K', label: 'Starting From' },
